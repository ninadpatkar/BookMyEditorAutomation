...
public class CreateBookingAndAcceptTest {
	...
	*/
	@Test(dataProvider="inputsBME", dataProviderClass=BMETestData.class, priority=1)
	public void createBookingAccept(String login_email, String login_passwd, String email, String service, String document, String subject, String enquiry, String units, String title, String job_date, String editor, String login_email_fl, String login_passwd_fl ) throws InterruptedException {
		...
		sa.assertEquals(flResponseStatus, "Accepted");
